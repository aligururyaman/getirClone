...
import KategoriData from '../../api/products.json'
...
const Kategoriler = () => {
  ...
  useEffect(() => {
    setProducts(KategoriData)
  }, [])

  return (
    <div>
        <Header />
        <div className='h-20 bg-primary-brand-color'>
        ...
        <div className='container mx-auto grid grid-cols-3'>
          ...
          <div className=''>
            ...
            <div className='flex flex-row gap-y-5'>
              {products && products.map((productsV,index) => <Products key={index} products={productsV}/>)}
            </div>
          </div>
          <div>
            sepet
